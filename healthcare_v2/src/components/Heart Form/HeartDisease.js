...
export default function HeartDisease() {
    ...
    const handleSubmit = () => {
        history.push({pathname:"/heartform/diet",state:{disease:disease,selected:location.state.selected}})
    }
        ...
        <section className='d-flex align-items-start form gray-bg' style={{ minHeight: window.innerWidth > 800 ? "78vh" : "76vh", paddingTop: "30px", flexDirection: 'column' }}>
            <div className="container-fluid pe-lg-5" >
                ...
                >
                    ...
                    <div className="row  justify-content-between align-items-center mb-8 flex-wrap-reverse">
