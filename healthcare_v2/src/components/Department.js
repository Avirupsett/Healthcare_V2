            ...
            >
                ...
                <div className='row'>
                    ...
                    <div className='col-xl-4 col-lg-6 col-md-6'>
                        <div className='box text-center'>
                            <div className="thumb" >
                                <HiOutlineSpeakerphone size={40} color={'var(--first-color)'} style={{ border: '1px solid var(--first-color)', borderRadius: "50%", padding: '5px', width: '75px', height: '70px' }} />
                                {/* <img style={{filter:"grayScale(1) opacity(0.8) drop-shadow(0 0 0 var(--first-color))"}} src="	https://themepure.net/template/medidove-prv/medidove/img/services/service1.png" alt="" /> */}
                            </div>
                            <div className="content">
                                <h3 className='fs-1' style={{ color: "var(--heading-color)" }}>Advisories</h3>
                                <p className='fs-6' style={{ color: "var(--text-color)" }}>The application offers a variety of preventative measures that are personalized to the specific disease.</p>
                                {/* <a className='fs-6' href='/predict'>Click here</a> */}
                            </div>
                    ...
                    <div className='col-xl-4 col-lg-6 col-md-6'>
                        <div className='box text-center'>
                            <div className="thumb">
                                <IoFastFoodOutline size={35} color={'var(--first-color)'} style={{ border: '1px solid var(--first-color)', borderRadius: "50%", padding: '5px', width: '75px', height: '70px' }} />
                                {/* <img style={{filter:"grayScale(1) opacity(0.8) drop-shadow(0 0 0 var(--first-color))"}} src="	https://themepure.net/template/medidove-prv/medidove/img/services/service4.png" alt="" /> */}
                            </div>
                            <div className="content">
                                <h3 className='fs-1' style={{ color: "var(--heading-color)" }}>Food Diet</h3>
                                <p className='fs-6' style={{ color: "var(--text-color)" }}>The application provides food diet charts to help users maintain a healthy lifestyle.</p>
                                {/* <a className='fs-6' href='/predict'>Click here</a> */}
                            </div>
                    ...
                    <div className='col-xl-4 col-lg-6 col-md-6'>
                        <div className='box text-center'>
                            <div className="thumb">
                                <CgSearchFound size={40} color={'var(--first-color)'} style={{ border: '1px solid var(--first-color)', borderRadius: "50%", padding: '5px', width: '75px', height: '70px' }} />
                                {/* <img style={{filter:"grayScale(1) opacity(0.8) drop-shadow(0 0 0 var(--first-color))"}} src="	https://themepure.net/template/medidove-prv/medidove/img/services/service6.png" alt="" /> */}
                            </div>
                            <div className="content">
                                <h3 className='fs-1' style={{ color: "var(--heading-color)" }}>Diagnosis</h3>
                                <p className='fs-6' style={{ color: "var(--text-color)" }}>The application offers a sophisticated diagnosis based on pathological features.</p>
                                {/* <a className='fs-6' href='/predict'>Click here</a> */}
                            </div>
